--[[
        Pump It Up Phoenix scoring system by SheepyChris, created on May 24, 2026
        Based entirely on accuracy (100% accuracy, no combo weighting).
        ...
        JudgmentMessageCommand=function(self, params)
            ...
            if State:GetPlayerController() ~= "PlayerController_Autoplay" then                
                ...
                if TapNote and TapNote:GetTapNoteType() ~= "TapNoteType_HoldTail" then
                    ...
                    -- Phoenix score is 99.5% accuracy + 0.5% max combo
